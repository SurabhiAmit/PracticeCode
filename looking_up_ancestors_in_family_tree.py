#For this question, your goal is to define a procedure that finds someone's ancestors,
...
def ancestors(genealogy, person):
    ...
    if person in genealogy:
        ...
        for each in genealogy[person]:
            if ancestors(genealogy, each):
                result+=(ancestors(genealogy, each))
    return result
